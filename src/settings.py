...
RELEASE_DATE: Optional[str] = "2022-08-12"  # e.g. "YYYY-MM-DD"
if RELEASE_DATE is None:
    RELEASE_YEAR: int = None

HOMEPAGE_URL: str = "https://crddc2022.sekilab.global/"
# e.g. "https://some.com/dataset/homepage"

PREVIEW_IMAGE_ID: int = 13085047
# This should be filled AFTER uploading images to instance, just ID of any image.

GITHUB_URL: str = "https://github.com/dataset-ninja/road-damage-detector"
...
REPOSITORY: Optional[Union[str, List[str], Dict[str, str]]] = {
    "GitHub": "https://github.com/sekilab/RoadDamageDetector?tab=readme-ov-file",
